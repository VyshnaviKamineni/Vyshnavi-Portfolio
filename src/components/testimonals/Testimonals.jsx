            ...
            <div className="testimonials__container container">
                <div className="testimonial">
                    ...
                    <div className="testimonial__author">
                        <img src="/testimonals/Mohana.png" alt="Author 1" className="testimonial__img" />
                ...
                <div className="testimonial">
                    ...
                    <div className="testimonial__author">
                        <img src="/testimonals/Manohar.png" alt="Author 2" className="testimonial__img" />
                ...
                <div className="testimonial">
                    ...
                    <div className="testimonial__author">
                        <img src="/testimonals/Raviteja.png" alt="Author 3" className="testimonial__img" />
