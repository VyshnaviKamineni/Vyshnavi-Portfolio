...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Vyshnavi Kamineni
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className='home__subtitle'>
            <Typewriter
            options={{
            strings: ['Front End Developer','AEM Developer', 'MERN Stack Developer'],
            autoStart: true,
            loop: true,
            deleteSpeed: 4,
            cursor: '|',
        ...
        <p className='home__description'>I'm a Software Engineer specializing in Front End Development, I have been an integral part of core development teams, delivering projects on time and enhancing user interface activities. <br />
                                        I seek a long-term association with a growth-oriented organization where I can take on added responsibilities and contribute to impactful projects.</p>

        <div className="button-container">
            <a href='#hire' className='button button--flex'>
                Hire Me
